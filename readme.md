...
- :green_heart: [Renovate Operator](https://github.com/mogenius/renovate-operator) :fire::fire: - Kubernetes operator to run self-hosted Renovate dependency update jobs with autodiscovery, parallelism control, and a built-in UI.
